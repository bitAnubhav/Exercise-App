...
const SearchExercises = ({setExercises , bodyPart , setBodyPart}) => {
  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="16px">
      <Typography
        fontWeight={700}
      ...
      <Box position="relative" mb="72px">
        <TextField
          height="76px"
          sx={{ input: { fontWeight: '700', border: 'none', borderRadius: '4px' }, width: { lg: '1170px', xs: '900px' }, backgroundColor: '#fff', borderRadius: '40px' }}
          value={search}
